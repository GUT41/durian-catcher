...
The inspiration for my game came from real durian harvest culture in Davao City, Philippines, known as the durian capital of the Philippines. Half jokingly though, the idea didn't come to me from learning about local culture. It actually came to me while mindlessly scrolling on TikTok late one night and happened to see a video of durian harvesters in Thailand catching freshly fallen durians in giant sacks. The way they timed their movements to position themselves underneath each tree perfectly to catch the durians before they hit the ground, it clicked to me that it'd make for such an intuitive one-button game mechanic. I wanted my game to feel local and personal to me, so I based it in Davao City with a Filipino-inspired harvest theme. Translating the concept into a game mechanic was simple: a durian falls from a tree, and you time your single button press to drop it into the awaiting farmer's sack below. The catcher automatically moves left to right, so player skill is purely based on reading his position and perfectly timing that one button press. Perfect for the one-button one-life rules of the Game Jam, I called it Durian Catcher because that's exactly what happens in real life if you miss — there's no second chance, the falling durian either hits the sack or it doesn't.
